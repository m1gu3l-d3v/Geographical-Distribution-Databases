...
INSERT INTO `colombia_departments` (`id`, `name`) VALUES
(5,'Antioquia'),
(8,'Atlántico'),
(11,'Bogotá, d.c.'),
(13,'Bolívar'),
...
CREATE TABLE `colombia_municipality` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
...
INSERT INTO `colombia_municipality` (`id`, `name`, `state`, `department_id`)
VALUES
(1,'Abriaquí',1,5),
(2,'Acacías',1,50),
(3,'Acandí',1,27),
...
ALTER TABLE `colombia_departments`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `colombia_municipality`
  ADD PRIMARY KEY (`id`);
